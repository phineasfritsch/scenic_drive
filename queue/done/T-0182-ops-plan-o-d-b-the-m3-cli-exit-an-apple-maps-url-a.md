...
- 2026-09-25T20:50:38Z MERGE OF MAIN after sign-off, by agent/claude-opus-5-5 (orchestrator; the #106 / #113 precedent): PRs #125, #126, #127 and #128 merged under this branch after rv1-pr124's PASS, and ops/lib/check-mutate-population.py conflicted in DRIVERS - this branch added plan.py, main added straightline.py. Resolved as the UNION, alphabetical: budget, extractadapter, gates, geometry, guidance, handoff, hazards, plan, retrace, routescore, scenic_tags, segmentscore, straightline, surfacecoverage. The union took the file to 301 lines, one over CLAUDE.md's cap; one blank line between MODULE_ROOTS and DRIVERS was dropped (no code moved) and it is 300. Re-run BARE on the merged head, because the file is a gate main changed: python ops/lib/check-mutate-population.py -> 'every added module is covered or allowlisted; the floor of 34 holds'; python ops/mutate/plan.py --prove-floor -> 'the shipped table accepted'; python ops/mutate/straightline.py --prove-floor -> 'FLOOR PROOF OK: 8 of 8 arms refused and the control did not'; swift test --scratch-path .build/T0182 -> 'Test run with 324 tests in 44 suites passed' (321 at review + #125's three); bash ops/queue-check -> QUEUE OK. No source, test, pin or fixture of this task changed in the merge.
