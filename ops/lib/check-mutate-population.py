...
DRIVERS = ("budget.py", "extractadapter.py", "gates.py", "geometry.py", "guidance.py", "handoff.py",
           "hazards.py", "menu.py", "plan.py", "retrace.py", "routescore.py", "scenic_tags.py",
...
COVERED_FLOOR = ("services/etl/etl/accessrule.py", "services/etl/etl/extractadapter.py",
    ...
    "Sources/Handoff/StraightLineDistance.swift", "Sources/ScenicKit/Menu/RouteMenu.swift",
    ...
    "Sources/ScenicKit/Scoring/SegmentTerms.swift", "Sources/ScenicKit/Menu/MenuRow.swift",
